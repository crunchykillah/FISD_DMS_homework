...
public class ClientHandler implements Runnable {
    ...
    private String filePath = "oris_02_MAZE_GAME/src/main/resources/clients.txt";
            ...
            while ((inputLine = in.readLine()) != null) {
                ...
                if (command.equals("start")) {
                    ...
                    if (maze.isGameFinished() && validMove) {
                        ...
                        sendMessage(JsonObjectCreator.statusStop(String.valueOf(maze.getSteps()),minSteps).toString());
                    } else {
